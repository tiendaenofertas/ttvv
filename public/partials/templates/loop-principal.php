...
$image_feature     = $data->get_image_featured($id, 'thumbnail');
...
?>
<article <?php echo ($trailer) ? 'preview="' . $trailer. '"' : ''; ?> class="loop-post vdeo snow-b sw03 pd08 por ovh <?php echo ($cl) ? $cl : ''; ?>">
    <div class="thumb por">
        <figure class="por ovh">
           
            <?php the_post_thumbnail( 'thumbnail', array( 'loading' => 'lazy', 'class' => 'poa w100p h100p ofc' ) ) ?>
        </figure>
