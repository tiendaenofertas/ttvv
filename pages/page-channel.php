...
$enable_alphabet_channel_archive = get_option('enable_alphabet_channel_archive');
$channel_archive_number          = get_option('channel_archive_number');
if( !$channel_archive_number ) $channel_archive_number = 5;
        ...
        <div class="site dgd gt1 gr16 gc32 e-gc64 cnt mt24 c-mt32">
            <main class="main dfx fdc" role="main">
                <section class="mt24 c-mt32">
                    ...
                    <?php if($enable_alphabet_channel_archive ){ ?>
                                    ...
                                    <article class="snow-b sw03 pd08 por ovh">
                                        <div class="thumb por">
                                            <figure class="por ovh">
                                                <img class="poa w100p h100p ofc" src="<?php echo $image; ?>" width="350" height="520" alt="<?php echo $name; ?>">
                                            </figure>
