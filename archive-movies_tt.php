...
?>
    ...
    <div id="content">
        ...
        <div class="site dgd gt1 gr16 gc32 e-gc64 cnt mt24 c-mt32">
            ...
            <main class="main dfx fdc" role="main">
                ...
                <section class="mt24 c-mt32">
					<header class="dfx aic fww f12 c-f16">
                        <h1 class="ttl f24 h123-c py08 mr16"><?php echo lang_torotube('Movies', 'lang_movies'); ?></h1>
					</header>
            ...
            <?php
			if( (get_option('torotube_sidebar_general')!=false and get_option('torotube_sidebar_general') != 'tt-nsdb') or  ( get_option('torotube_sidebar_single')!=false and get_option('torotube_sidebar_single') != 'tt-nsdb') ){
				get_sidebar();
			}
			?>
